...
class CarRacing:
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Urvish')
        self.run_car()
    ...
    def display_credit(self):
        ...
        text = font.render("Urvish Pandya", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("urvishpandya14@gmail.com", True, self.white)
